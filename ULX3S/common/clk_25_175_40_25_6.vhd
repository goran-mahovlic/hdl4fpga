...
-- Module  Version: 5.7
--/usr/local/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25_175_40_25_6 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -clkibuf LVDS -fclkop 175.00 -fclkop_tol 0.0 -fclkos 40.00 -fclkos_tol 1.0 -phases 0 -fclkos2 25.00 -fclkos2_tol 0.0 -phases2 0 -fclkos3 6.00 -fclkos3_tol 1.0 -phases3 0 -phase_cntl STATIC -fb_mode 1 -fdc /fpga/hdl4fpga/ULX3S/common/ckock/clk_25_175_40_25_6/clk_25_175_40_25_6.fdc 

-- Mon Mar  9 00:12:29 2020
...
end clk_25_175_40_25_6;

architecture Structure of clk_25_175_40_25_6 is
    ...
    attribute FREQUENCY_PIN_CLKOS3 of PLLInst_0 : label is "5.965909";
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "25.000000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "40.384615";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS3_FPHASE=>  0, CLKOS3_CPHASE=>  87, CLKOS2_FPHASE=>  0, 
        CLKOS2_CPHASE=>  20, CLKOS_FPHASE=>  0, CLKOS_CPHASE=>  12, 
        ...
        OUTDIVIDER_MUXA=> "DIVA", CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  88, 
        CLKOS2_DIV=>  21, CLKOS_DIV=>  13, CLKOP_DIV=>  3, CLKFB_DIV=>  7, 
